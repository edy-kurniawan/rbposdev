...
<html>
              ...
              <input type="hidden" value="" name="id"/>
                <div class="form-body"> 
                  ...
                  <div class="form-group">
                    <label>Kode</label>
                      <input type="text" class="form-control" placeholder="Masukan Nama" name="kode" required>
      ...
      <div class="col-xs-12">
        ...
        <div class="box box-info">
          <div class="box-header">
              <button class="btn btn-primary pull-right" onclick="add_kategori()" data-toggle="tooltip" data-placement="top" title="Tambah Data"><span class="glyphicon glyphicon-file"></span>Tambah</button>
  ...
  <script src="<?php echo base_url(); ?>assets/AdminLTE/bootstrap/js/moment.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
          table = $('#table').DataTable({  
            "processing": true, 
            "ajax": {
                "url": "<?php echo base_url('gudang/kategori/setView'); ?>",
                "type": "POST",
            },
            "columns": [
    ...
    $.ajax({
    url : "<?php echo base_url('gudang/kategori/ajax_edit')?>/" + id,
    type: "GET",
    dataType: "JSON",
    ...
    if(save_method == 'add') {
    url = "<?php echo base_url('gudang/kategori/ajax_add')?>";
    } else {
    url = "<?php echo base_url('gudang/kategori/ajax_update')?>";
    }
    ...
    $.ajax({
    url : "<?php echo base_url('gudang/kategori/ajax_delete')?>/" +id,
    type: "POST",
    dataType: "JSON",
    success: function(data)
    {
