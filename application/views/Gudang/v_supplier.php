...
<html>
            ...
            <form  id="form" class="form-horizontal">
              <input type="hidden" value="" name="id"/>
                <div class="form-body"> 
                  ...
                  <div class="form-group">
                    <label>Telp</label>
                      <input type="text" class="form-control" placeholder="Masukan Telp" name="telp" required>
                      <i class="form-control-feedback"></i><span class="text-warning" ></span>
                  </div>  
                  <div class="form-group">
                    <label>Fax</label>
      ...
      <div class="col-xs-12">
        ...
        <div class="box box-info">
          <div class="box-header">
              <button class="btn btn-primary pull-right" onclick="add_supplier()" data-toggle="tooltip" data-placement="top" title="Tambah Data"><span class="glyphicon glyphicon-file"></span>Tambah</button>
  ...
  <script src="<?php echo base_url(); ?>assets/AdminLTE/bootstrap/js/moment.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
          table = $('#table').DataTable({  
            "processing": true, 
            "ajax": {
                "url": "<?php echo base_url('gudang/supplier/setView'); ?>",
                "type": "POST",
            },
            "columns": [
    ...
    $('.modal-title').text('Input supplier'); // Set Title to Bootstrap modal title
    }
    ...
    $.ajax({
    url : "<?php echo base_url('gudang/supplier/ajax_edit')?>/" + id,
    type: "GET",
    dataType: "JSON",
    ...
    if(save_method == 'add') {
    url = "<?php echo base_url('gudang/supplier/ajax_add')?>";
    } else {
    url = "<?php echo base_url('gudang/supplier/ajax_update')?>";
    }
    ...
    $.ajax({
    url : "<?php echo base_url('gudang/supplier/ajax_delete')?>/" +id,
    type: "POST",
    dataType: "JSON",
    success: function(data)
    {
