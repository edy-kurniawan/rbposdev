...
<html>
      ...
      <div class="col-xs-12">
        ...
        <div class="box box-info">
          <div class="box-header">
              <button class="btn btn-primary pull-right" onclick="add_jabatan()" data-toggle="tooltip" data-placement="top" title="Tambah Data"><span class="glyphicon glyphicon-file"></span>Tambah</button>
  ...
  <script src="<?php echo base_url(); ?>assets/AdminLTE/bootstrap/js/moment.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
          table = $('#table').DataTable({  
            "processing": true, 
            "ajax": {
                "url": "<?php echo base_url('hrd/jabatan/setView'); ?>",
                "type": "POST",
            },
            "columns": [
    ...
    $('.modal-title').text('Input Jabatan'); // Set Title to Bootstrap modal title
    }
    ...
    $.ajax({
    url : "<?php echo base_url('hrd/jabatan/ajax_edit')?>/" + id,
    type: "GET",
    dataType: "JSON",
    ...
    if(save_method == 'add') {
    url = "<?php echo base_url('hrd/jabatan/ajax_add')?>";
    } else {
    url = "<?php echo base_url('hrd/jabatan/ajax_update')?>";
    }
    ...
    $.ajax({
    url : "<?php echo base_url('hrd/jabatan/ajax_delete')?>/" +id,
    type: "POST",
    dataType: "JSON",
    success: function(data)
    {
